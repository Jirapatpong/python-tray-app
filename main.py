...
class App:
    ...
    def __init__(self, master, lock_file_path):
        ...
        self.stream_hwnd = None  # NEW: track scrcpy window handle
    ...
    # --- Screen Streaming Methods (REVISED) ---
    def _start_stream(self):
        ...
        # If already streaming, just resize to current frame
        if self.scrcpy_process and self.stream_hwnd:
            print("Stream already running, just resizing to frame.")
            self._resize_stream_to_frame()
            return
        ...
        # Ensure scrcpy uses the same ADB as the app
        env = os.environ.copy
